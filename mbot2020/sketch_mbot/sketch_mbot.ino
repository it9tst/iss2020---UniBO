...
float rotLeftTime  = 0.45;
float rotRightTime = 0.45;
...
void remoteCmdExecutor(){
    if(Serial.available() > 0){
        ...
        switch(input){
            ...
            case 119 : moveBot(1,stepSize); break;  //w
            case 115 : moveBot(2,stepSize); break;  //s
            case 97  : moveBot(3,stepSize); break;  //a
            case 100 : moveBot(4,stepSize); break;  //d
